...
public class EstacionamentoRepository {
    ...
    private Connection obterConexao() throws SQLException {
        try {
            ...
            // Em ambientes modernos JDBC 4.0+, Class.forName é opcional, mas mantido para compatibilidade retroativa
        }
    ...
    private void inicializarBanco() {
        ...
        // Migrações seguras para adicionar colunas se elas não existirem
        ...
        for (String alter : alterStatements) {
            try (Connection conn = obterConexao();
                ...
                // Colunas já existem, ignora com segurança
            }
        }
    }
    ...
    public void salvarVeiculos(List<Veiculo> veiculos) throws IOException {
        ...
        try (Connection conn = obterConexao()) {
            conn.setAutoCommit(false); // Transação para segurança e performance
    ...
    public void registrarTerminal(String hardwareId, String nomeAparelho, String soTipo) {
        ...
        try (Connection conn = obterConexao();
            ...
            pstmt.setLong(5, 0); // Sem expiração inicial
